...
// server command line: java -jar ./build/distributions/denis-map-test_aws_supplier-1.0.0/lib/denis-map-test_aws_supplier-1.0.0.jar <fileName. Default: ./files/test.csv> <fullWorkWindow in sec. Default: 120> <sleepInterval in sec. Default: 10>
// example: java -jar ./build/distributions/denis-map-test_aws_supplier-1.0.0/lib/denis-map-test_aws_supplier-1.0.0.jar ./files/test.csv 120 10
// example using script with defaults: ./build/distributions/denis-map-test_aws_supplier-1.0.0/bin/denis-map-test_aws_supplier
